...
Slide.create(id: 1, image: "backdrops/Slide_1_hi_res.png", story_id: 1, description: "You leave the village and come across an old, rickety bridge. You have two choices, both of which of a element of death! Do you...")
...
Slide.create(id: 9, image: "backdrops/Slide_end.png", story_id: 1, description: "AAAHHHHHHHH!!!! The spiders cover you from head to toe and you can’t get away!! THE END Please try again to save the sacred Goblet!")
...
Slide.create(id: 12, image: "backdrops/Slide_12_hi_res.png", story_id: 1, description: "WOW! Your hypnotizing eye’s sent the snake into a deep sleep! This doesn't look good, you see a dark, terrifying spirit. What now ninja..")

Slide.create(id: 13, image: "backdrops/Slide_end.png", story_id: 1, description: "STOMP!! Frank hopped from his boulders and squished you…..THE END Please try again to save the sacred Goblet!")
...
Slide.create(id: 16, image: "backdrops/Slide_14,16,18_hi_res.png", story_id: 1, description: "Well done! The Mage lets you past, he was nice all along! The legends are true, the mythical dragon, IFRIT, is alive and he has the Goblet!!! What are YOU going to do Ninja??")

Slide.create(id: 17, image: "backdrops/Slide_end.png", story_id: 1, description: "WHOOSH! The evil spirit sucks you up and throws you back to the beginning… THE END Please try again to save the sacred Goblet!")
